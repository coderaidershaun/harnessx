...
Check the rework milestone's tasks. Count how many verification tasks already exist (tasks with title starting "VERIFY:"). If there are already 3 or more:
...
- The rework milestone ID can be found by tracing this task's parent: `harnessx planning-tasks parent [THIS-TASK-ID]` — this returns the milestone directly for v2 tasks
